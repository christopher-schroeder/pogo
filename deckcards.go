...
var card [DECK_SIZE]uint32 = [DECK_SIZE]uint32{
...
var suit [DECK_SIZE]uint8 = [DECK_SIZE]uint8 {
...
var suit_kronecker [NUMBER_OF_SUITS][DECK_SIZE]uint16 = [NUMBER_OF_SUITS][DECK_SIZE]uint16 {
  {
    ACE_FLUSH,   0, 0, 0,
    KING_FLUSH,  0, 0, 0,
    QUEEN_FLUSH, 0, 0, 0,
